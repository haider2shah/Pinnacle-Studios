...
const ThirdServicesCard = ({ title, paragraph, image,imageMobile,icon,iconTwo,iconThree,iconParagraphOne,iconParagraphTwo,iconParagraphThree, iconHeadingOne, iconHeadingTwo,iconHeadingThree}) => {
    return (
