...
const ServicesCard = ({ title, paragraph, image,icon,iconTwo,iconThree,iconParagraphOne,iconParagraphTwo,iconParagraphThree, iconHeadingOne, iconHeadingTwo,iconHeadingThree,imageMobile}) => {
    return (
        ...
        <div className= {Styles.wrapper}>
            <div >
                <div className= {Styles.card}>
                        ...
                        >
                            <Image className= {Styles.image} alt={title} width={0} height={0} src= {image} unoptimized priority/>
                        </motion.div>
                        <motion.div
                            className= {Styles.picture}
                            initial={{ opacity: 0, y: 30 }}
                            ...
                            transition={{ duration: 0.9, delay: 0.15, ease: 'easeOut' }}
                        >
                            <Image className= {Styles.imageMobile} alt={title} width={0} height={0} src= {imageMobile} unoptimized priority/>
                        </motion.div>
