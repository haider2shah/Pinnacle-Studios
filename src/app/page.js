  ...
  return (
    <>
      ...
      <section className={styles.hero} onMouseMove={handleMouseMove}>
        ...
        >
          ...
          <motion.div className={styles.heroSmallImage} style={{ y }}>
            <motion.img className={styles.heroImageOne} src="/image3.webp" alt="" style={{ x: p1x, y: p1y }} />
            <motion.img className={styles.heroImageTwo} src="/image8.webp" alt="" style={{ x: p2x, y: p2y }} />
            <motion.img className={styles.heroImageThree} src="/image9.webp" alt="" style={{ x: p3x, y: p3y }} />
            <motion.img className={styles.heroImageFour} src="/image10.webp" alt="" style={{ x: p4x, y: p4y }} />
            <motion.img className={styles.heroImageFive} src="/image1.webp" alt="" style={{ x: p5x, y: p5y }} />
            <motion.img className={styles.heroImageSix} src="/image7.webp" alt="" style={{ x: p6x, y: p6y }} />
          </motion.div>
        </motion.div>
      ...
      <section className={styles.aiSection}>
        ...
        >
          <svg className={styles.aiLogo} viewBox="0 0 24 24" fill="#ffffff" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
            <path d="M12 2c.24 0 .45.16.51.4l1.1 4.36a4.9 4.9 0 0 0 3.63 3.63l4.36 1.1a.53.53 0 0 1 0 1.02l-4.36 1.1a4.9 4.9 0 0 0-3.63 3.63l-1.1 4.36a.53.53 0 0 1-1.02 0l-1.1-4.36a4.9 4.9 0 0 0-3.63-3.63l-4.36-1.1a.53.53 0 0 1 0-1.02l4.36-1.1a4.9 4.9 0 0 0 3.63-3.63l1.1-4.36c.06-.24.27-.4.51-.4Z" />
            <path d="M19 14c.2 0 .38.14.43.33l.5 1.74a1.7 1.7 0 0 0 1.16 1.16l1.74.5a.45.45 0 0 1 0 .86l-1.74.5a1.7 1.7 0 0 0-1.16 1.16l-.5 1.74a.45.45 0 0 1-.86 0l-.5-1.74a1.7 1.7 0 0 0-1.16-1.16l-1.74-.5a.45.45 0 0 1 0-.86l1.74-.5a1.7 1.7 0 0 0 1.16-1.16l.5-1.74A.45.45 0 0 1 19 14Z" />
            <path d="M5.5 2.5c.17 0 .32.11.37.28l.32 1.05c.15.5.54.89 1.04 1.04l1.05.32a.4.4 0 0 1 0 .76l-1.05.32c-.5.15-.89.54-1.04 1.04l-.32 1.05a.4.4 0 0 1-.76 0l-.32-1.05a1.63 1.63 0 0 0-1.04-1.04L2.7 6.05a.4.4 0 0 1 0-.76l1.05-.32c.5-.15.89-.54 1.04-1.04l.32-1.05c.06-.17.2-.28.37-.28Z" />
          </svg>
        </motion.div>
